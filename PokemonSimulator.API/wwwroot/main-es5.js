...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _shared_token_interceptor__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(
  ...
  function srcAppPokemonPokemonRegisterPokemonRegisterComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function PokemonRegisterComponent_p_108_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function PokemonRegisterComponent_p_143_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "p", 44);
    ...
    function PokemonRegisterComponent_p_144_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "p", 44);
    ...
    PokemonRegisterComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function PokemonRegisterComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function PokemonRegisterComponent_Template_button_click_106_listener($event) {
            return ctx.SetIvsToMax();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("selected", function PokemonRegisterComponent_Template_app_move_dropdown_selected_154_listener($event) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("selected", function PokemonRegisterComponent_Template_app_move_dropdown_selected_157_listener($event) {
  ...
  function srcAppPokemonPokemonSearchPokemonSearchComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function PokemonSearchComponent_div_7_ng_container_2_span_16_Template(rf, ctx) {
      ...
      if (rf & 2) {
        var pokemon_r21 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
    ...
    function () {
      ...
      _createClass(BasicDropdownComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.clear.subscribe(function () {
            _this14.selectedItem = 0;
          });
        }
      }, {
        key: "setItem",
  ...
  function srcAppSharedLayoutsHeaderHeaderComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function HeaderComponent_li_26_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HeaderComponent_li_26_Template_a_click_1_listener($event) {
    ...
    HeaderComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 27,
      vars: 4,
      consts: [[1, "navbar", "navbar-inverse", "set-radius-zero"], [1, "container"], [1, "navbar-header"], ["type", "button", "data-toggle", "collapse", "data-target", ".navbar-collapse", 1, "navbar-toggle", 3, "click"], [1, "icon-bar"], ["src", "./assets/images/pokemon calculator.png", 1, "navbar-img"], ["src", "./assets/images/pokemon_PNG127.png", 1, "navbar-img"], [1, "menu-section"], [1, "row"], [1, "col-md-12"], ["id", "menu-top", 1, "nav", "navbar-nav", "navbar-right"], ["href", "/", 1, "menu-top-active"], ["href", "/search"], ["href", "/simulation"], [4, "ngIf"], ["href", "/login"], [3, "click"]],
      ...
      directives: [_ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_3__["ɵm"], _angular_common__WEBPACK_IMPORTED_MODULE_4__["NgIf"]],
  ...
  function srcAppSharedServicesAuthServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function (_main_service__WEBPAC) {
      ...
      function AuthService(http) {
        ...
        _this15 = _possibleConstructorReturn(this, _getPrototypeOf(AuthService).call(this, 'Auth/'));
        _this15.http = http;
        return _this15;
      }
  ...
  /***/
  function srcAppSharedTokenInterceptorTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppSimulationSimulationCardSimulationCardComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _pokemon_pokemon_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ../../pokemon/pokemon.service */
    "./src/app/pokemon/pokemon.service.ts");
    /* harmony import */
    ...
    var _shared_layouts_basic_dropdown_basic_dropdown_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ../../shared/layouts/basic-dropdown/basic-dropdown.component */
    "./src/app/shared/layouts/basic-dropdown/basic-dropdown.component.ts");
    /* harmony import */
    ...
    function () {
      ...
      _createClass(SimulationCardComponent, [{
        ...
        value: function listPokemons() {
          ...
          this.pokemonService.listPokemons().subscribe(function (resp) {
            _this16.pokemons = resp;
            resp.forEach(function (pokemon) {
              var pokemonName = "".concat(pokemon.pokemonSpecies.name.toUpperCase(), " - level ").concat(pokemon.level);

              _this16.pokemonsDropdown.push(new _shared_layouts_basic_dropdown_basic_dropdown_entity__WEBPACK_IMPORTED_MODULE_1__["BasicDropdownEntity"](pokemon.id, pokemonName));
            });

            if (!!_this16.selectedPokemon) {
              _this16.setPokemon(_this16.selectedPokemon.toString());
            }
          });
        }
      }, {
        ...
        value: function setPokemon(id) {
          ...
          if (this.authService.isLogged()) {
            this.pokemonService.getPokemon(id).subscribe(function (resp) {
              _this17.simulationPokemon = new _simulation_pokemon__WEBPACK_IMPORTED_MODULE_2__["SimulationPokemon"](resp);

              if (_this17.isAttacking) {
                _this17.simulationForm.get('attacking_pokemon_id').setValue(resp.id);

                _this17.movesDropdown = [];

                if (!!resp.move1) {
                  var move1_text = "".concat(resp.move1.name, " - Power: ").concat(resp.move1.basePower, " - ").concat(resp.move1.category);

                  _this17.movesDropdown.push(new _shared_layouts_basic_dropdown_basic_dropdown_entity__WEBPACK_IMPORTED_MODULE_1__["BasicDropdownEntity"](1, move1_text));
                }

                if (!!resp.move2) {
                  var move2_text = "".concat(resp.move2.name, " - Power: ").concat(resp.move2.basePower, " - ").concat(resp.move2.category);

                  _this17.movesDropdown.push(new _shared_layouts_basic_dropdown_basic_dropdown_entity__WEBPACK_IMPORTED_MODULE_1__["BasicDropdownEntity"](2, move2_text));
                }

                if (!!resp.move3) {
                  var move3_text = "".concat(resp.move3.name, " - Power: ").concat(resp.move3.basePower, " - ").concat(resp.move3.category);

                  _this17.movesDropdown.push(new _shared_layouts_basic_dropdown_basic_dropdown_entity__WEBPACK_IMPORTED_MODULE_1__["BasicDropdownEntity"](3, move3_text));
                }

                if (!!resp.move4) {
                  var move4_text = "".concat(resp.move4.name, " - Power: ").concat(resp.move4.basePower, " - ").concat(resp.move4.category);

                  _this17.movesDropdown.push(new _shared_layouts_basic_dropdown_basic_dropdown_entity__WEBPACK_IMPORTED_MODULE_1__["BasicDropdownEntity"](4, move4_text));
                }
              } else {
                _this17.simulationForm.get('defending_pokemon_id').setValue(resp.id);
              }

              _this17.changed.emit(_this17.simulationPokemon);
            });
          } else {
        ...
        value: function clearForm() {
          this.movesDropdown = [];
          this.clearMoveDrop.next(true); // if (this.isAttacking)
          // {
    ...
    SimulationCardComponent.ɵfac = function SimulationCardComponent_Factory(t) {
      return new (t || SimulationCardComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_shared_services_auth_service__WEBPACK_IMPORTED_MODULE_5__["AuthService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_pokemon_pokemon_service__WEBPACK_IMPORTED_MODULE_6__["PokemonService"]));
    };
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SimulationCardComponent, [{
        ...
        return [{
          ...
          type: _pokemon_pokemon_service__WEBPACK_IMPORTED_MODULE_6__["PokemonService"]
        }];
      }, {
        simulationForm: [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"]
  ...
  function srcAppSimulationSimulationServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function (_shared_services_main5) {
      ...
      function SimulationService(http) {
        ...
        _this18 = _possibleConstructorReturn(this, _getPrototypeOf(SimulationService).call(this, 'simulation'));
        _this18.http = http;
        return _this18;
      }
      ...
      _createClass(SimulationComponent, [{
        ...
        value: function simulateBattle() {
          ...
          this.simulationService.getDamage(simulationDto).subscribe(function (resp) {
            var damage = resp.damage;
            var attacker_name = _this20.attackingPokemon.pokemon.pokemonSpecies.name;
            var defender_name = _this20.defendingPokemon.pokemon.pokemonSpecies.name;
            var movename = _this20.attackingPokemon.move.name;
            var defenderHp = _this20.defendingPokemon.pokemon.hp;
            _this20.battleResultsTitle = "Pokemon ".concat(attacker_name.toUpperCase(), " attacked ").concat(defender_name.toUpperCase(), " with ").concat(movename, ".");
            _this20.battleResults = "".concat(movename, " took ").concat(damage, " of damage.\n\n      ").concat(defender_name.toUpperCase(), " HP dropped from ").concat(defenderHp, " to ").concat(defenderHp - damage, ".\n ").concat((damage / defenderHp * 100).toFixed(0), "% of its total HP.\n\n      ").concat(resp.effect);
          });
        }
      }, {
        key: "getCSSClass",
      ...
      _createClass(LoginComponent, [{
        ...
        value: function login() {
          ...
          this.authService.login(user).subscribe(function (res) {
            _this21.authService.setToken(res.accessToken);
      ...
      _createClass(SignUpComponent, [{
        ...
        value: function signUp() {
          ...
          this.authService.signUp(user).subscribe(function (response) {
            ...
            _this22.toastr.error(error.error.message);
        ...
        value: function login(user) {
          ...
          this.authService.login(user).subscribe(function (res) {
            _this23.authService.setToken(res.accessToken);
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /Users/mathiasvoelcker/Desktop/Developer/Csharp/PokemonCalculator/PokemonSimulator/pokeSimulatorFront/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
